...
export function morpheusstate_new(a: number): void;
export function morpheusstate_is_corrupted(a: number): number;
export function morpheusstate_lastBlockHeight(a: number, b: number): void;
export function morpheusstate_isConfirmed(a: number, b: number, c: number, d: number): void;
export function morpheusstate_beforeProofExistsAt(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function morpheusstate_beforeProofHistory(a: number, b: number, c: number, d: number): void;
export function morpheusstate_getTransactionHistory(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): void;
export function morpheusstate_lastTxId(a: number, b: number, c: number, d: number): void;
export function morpheusstate_getDidDocumentAt(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function morpheusstate_dryRun(a: number, b: number, c: number): void;
export function morpheusstate_blockApplying(a: number, b: number, c: number): void;
export function morpheusstate_applyTransaction(a: number, b: number, c: number, d: number, e: number): void;
export function morpheusstate_blockReverting(a: number, b: number, c: number): void;
export function morpheusstate_revertTransaction(a: number, b: number, c: number, d: number, e: number): void;
export function __wbg_diddocument_free(a: number): void;
export function __wbg_coeusstate_free(a: number): void;
export function coeusstate_new(a: number): void;
export function coeusstate_resolveData(a: number, b: number, c: number): void;
export function coeusstate_getMetadata(a: number, b: number, c: number): void;
export function coeusstate_getChildren(a: number, b: number, c: number): void;
export function coeusstate_lastNonce(a: number, b: number, c: number): void;
export function coeusstate_applyTransaction(a: number, b: number, c: number, d: number, e: number): void;
export function coeusstate_revertTransaction(a: number, b: number, c: number, d: number, e: number): void;
export function coeusstate_blockApplying(a: number, b: number, c: number): void;
export function coeusstate_blockReverted(a: number, b: number, c: number): void;
...
export function coeusstate_getTxnStatus(a: number, b: number, c: number, d: number): void;
