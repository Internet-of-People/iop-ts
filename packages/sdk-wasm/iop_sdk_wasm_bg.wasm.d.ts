...
export function morpheustxbuilder_build(a: number, b: number, c: number, d: number, e: number, f: number): number;
...
export function morpheusassetbuilder_build(a: number): number;
export function __wbg_morpheussignableoperation_free(a: number): void;
export function morpheussignableoperation_toJSON(a: number): number;
...
export function morpheusoperationsigner_signWithKey(a: number, b: number): number;
export function morpheusoperationsigner_sign(a: number, b: number, c: number): number;
export function __wbg_morpheussignedoperation_free(a: number): void;
export function morpheussignedoperation_toJSON(a: number): number;
...
export function morpheuspublic_kind(a: number, b: number, c: number): number;
export function morpheuspublic_personas(a: number): number;
export function morpheuspublic_devices(a: number): number;
export function morpheuspublic_groups(a: number): number;
export function morpheuspublic_resources(a: number): number;
...
export function morpheusprivate_kind(a: number, b: number, c: number): number;
export function morpheusprivate_personas(a: number): number;
export function morpheusprivate_devices(a: number): number;
export function morpheusprivate_groups(a: number): number;
export function morpheusprivate_resources(a: number): number;
...
export function signedjson_toJSON(a: number): number;
export function signedjson_fromJSON(a: number): number;
...
export function morpheusroot_kind(a: number, b: number, c: number): number;
export function morpheusroot_personas(a: number): number;
export function morpheusroot_devices(a: number): number;
export function morpheusroot_groups(a: number): number;
export function morpheusroot_resources(a: number): number;
