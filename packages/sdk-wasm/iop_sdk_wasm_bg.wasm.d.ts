...
export function vault_create(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
export function vault_load(a: number, b: number): void;
export function vault_save(a: number, b: number): void;
export function vault_is_dirty(a: number, b: number): void;
export function vault_setDirty(a: number, b: number): void;
export function vault_unlock(a: number, b: number, c: number, d: number): void;
export function __wbg_morpheustxbuilder_free(a: number): void;
export function morpheustxbuilder_build(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number): void;
export function __wbg_morpheusassetbuilder_free(a: number): void;
export function morpheusassetbuilder_new(): number;
export function morpheusassetbuilder_addRegisterBeforeProof(a: number, b: number, c: number): void;
export function morpheusassetbuilder_addSigned(a: number, b: number): void;
export function morpheusassetbuilder_build(a: number, b: number): void;
export function __wbg_morpheussignableoperation_free(a: number): void;
export function morpheussignableoperation_new(a: number, b: number): void;
export function morpheussignableoperation_toJSON(a: number, b: number): void;
export function __wbg_morpheusoperationbuilder_free(a: number): void;
export function morpheusoperationbuilder_new(a: number, b: number, c: number, d: number): void;
export function morpheusoperationbuilder_addKey(a: number, b: number, c: number, d: number, e: number): void;
export function morpheusoperationbuilder_revokeKey(a: number, b: number, c: number, d: number): void;
export function morpheusoperationbuilder_addRight(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function morpheusoperationbuilder_revokeRight(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function morpheusoperationbuilder_tombstoneDid(a: number, b: number): void;
export function __wbg_morpheusoperationsigner_free(a: number): void;
export function morpheusoperationsigner_new(): number;
export function morpheusoperationsigner_add(a: number, b: number): void;
export function morpheusoperationsigner_signWithKey(a: number, b: number, c: number): void;
export function morpheusoperationsigner_sign(a: number, b: number, c: number, d: number): void;
export function morpheusoperationsigner_signWithId(a: number, b: number, c: number, d: number): void;
export function __wbg_morpheussignedoperation_free(a: number): void;
export function morpheussignedoperation_new(a: number, b: number): void;
export function morpheussignedoperation_toJSON(a: number, b: number): void;
...
export function morpheusprivatekind_bip32_path(a: number, b: number): void;
export function morpheusprivatekind_count(a: number, b: number): void;
export function morpheusprivatekind_neuter(a: number): number;
export function morpheusprivatekind_key(a: number, b: number, c: number): void;
export function morpheusprivatekind_did(a: number, b: number, c: number): void;
export function morpheusprivatekind_keyByPublicKey(a: number, b: number, c: number): void;
export function __wbg_hydrapublic_free(a: number): void;
export function hydrapublic_network(a: number, b: number): void;
export function hydrapublic_key(a: number, b: number, c: number): void;
export function hydrapublic_xpub(a: number, b: number): void;
export function hydrapublic_receive_keys(a: number, b: number): void;
export function hydrapublic_change_keys(a: number, b: number): void;
export function hydrapublic_keyByAddress(a: number, b: number, c: number, d: number): void;
export function __wbg_hydrasigner_free(a: number): void;
export function hydrasigner_new(a: number): number;
export function hydrasigner_signHydraTransaction(a: number, b: number, c: number): void;
export function __wbg_hydraplugin_free(a: number): void;
export function hydraplugin_init(a: number, b: number, c: number, d: number, e: number): void;
export function hydraplugin_get(a: number, b: number, c: number): void;
export function hydraplugin_public(a: number, b: number): void;
export function hydraplugin_priv(a: number, b: number, c: number, d: number): void;
export function __wbg_morpheuspublic_free(a: number): void;
export function morpheuspublic_kind(a: number, b: number, c: number, d: number): void;
export function morpheuspublic_personas(a: number, b: number): void;
export function morpheuspublic_devices(a: number, b: number): void;
export function morpheuspublic_groups(a: number, b: number): void;
export function morpheuspublic_resources(a: number, b: number): void;
export function morpheuspublic_keyById(a: number, b: number, c: number): void;
...
export function morpheuspublickind_count(a: number, b: number): void;
export function morpheuspublickind_key(a: number, b: number, c: number): void;
export function morpheuspublickind_did(a: number, b: number, c: number): void;
export function morpheuspublickind_keyById(a: number, b: number, c: number): void;
export function __wbg_morpheusplugin_free(a: number): void;
export function morpheusplugin_init(a: number, b: number, c: number, d: number): void;
export function morpheusplugin_get(a: number, b: number): void;
export function morpheusplugin_public(a: number, b: number): void;
export function morpheusplugin_priv(a: number, b: number, c: number, d: number): void;
export function __wbg_hydraparameters_free(a: number): void;
export function hydraparameters_new(a: number, b: number, c: number, d: number): void;
...
export function hydraprivate_key(a: number, b: number, c: number): void;
export function hydraprivate_keyByPublicKey(a: number, b: number, c: number): void;
export function hydraprivate_xpub(a: number, b: number): void;
export function hydraprivate_xprv(a: number, b: number): void;
export function hydraprivate_receive_keys(a: number, b: number): void;
export function hydraprivate_change_keys(a: number, b: number): void;
export function hydraprivate_signHydraTransaction(a: number, b: number, c: number, d: number, e: number): void;
export function __wbg_hydratxbuilder_free(a: number): void;
export function hydratxbuilder_new(a: number, b: number, c: number): void;
export function hydratxbuilder_transfer(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number): void;
export function hydratxbuilder_vote(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): void;
export function hydratxbuilder_unvote(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): void;
export function hydratxbuilder_registerDelegate(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number): void;
export function __wbg_morpheusprivate_free(a: number): void;
export function morpheusprivate_public(a: number): number;
export function morpheusprivate_bip32_path(a: number, b: number): void;
export function morpheusprivate_kind(a: number, b: number, c: number, d: number): void;
export function morpheusprivate_personas(a: number, b: number): void;
export function morpheusprivate_devices(a: number, b: number): void;
export function morpheusprivate_groups(a: number, b: number): void;
export function morpheusprivate_resources(a: number, b: number): void;
export function morpheusprivate_keyByPublicKey(a: number, b: number, c: number): void;
export function morpheusprivate_keyById(a: number, b: number, c: number): void;
export function morpheusprivate_signDidOperations(a: number, b: number, c: number, d: number, e: number): void;
export function morpheusprivate_signWitnessRequest(a: number, b: number, c: number, d: number): void;
export function morpheusprivate_signWitnessStatement(a: number, b: number, c: number, d: number): void;
export function morpheusprivate_signClaimPresentation(a: number, b: number, c: number, d: number): void;
...
export function wrapWithNonce(a: number, b: number): void;
export function __wbg_signedbytes_free(a: number): void;
export function signedbytes_new(a: number, b: number, c: number, d: number, e: number): void;
...
export function signedbytes_validateWithDidDoc(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): void;
export function __wbg_signedjson_free(a: number): void;
export function signedjson_new(a: number, b: number, c: number, d: number): void;
export function signedjson_publicKey(a: number): number;
export function signedjson_content(a: number, b: number): void;
...
export function signedjson_validateWithDidDoc(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): void;
export function signedjson_toJSON(a: number, b: number): void;
export function signedjson_fromJSON(a: number, b: number): void;
...
export function principal_publicKey(a: number, b: number): void;
export function principal_validateImpersonation(a: number, b: number, c: number): void;
export function __wbg_domainname_free(a: number): void;
export function domainname_new(a: number, b: number, c: number): void;
...
export function noncedbundle_sign(a: number, b: number, c: number): void;
export function noncedbundle_serialize(a: number, b: number): void;
export function __wbg_signedbundle_free(a: number): void;
export function signedbundle_new(a: number, b: number): void;
...
export function coeusasset_new(a: number, b: number): void;
export function coeusasset_deserialize(a: number, b: number, c: number): void;
export function coeusasset_serialize(a: number, b: number): void;
export function coeusasset_fee(a: number, b: number): void;
export function coeusasset_toJSON(a: number, b: number): void;
...
export function jwtbuilder_timeToLive(a: number, b: number): void;
export function jwtbuilder_set_timeToLive(a: number, b: number, c: number): void;
export function jwtbuilder_sign(a: number, b: number, c: number): void;
export function __wbg_jwtparser_free(a: number): void;
export function jwtparser_new(a: number, b: number, c: number): void;
...
export function coeustxbuilder_new(a: number, b: number, c: number): void;
export function coeustxbuilder_build(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function __wbg_did_free(a: number): void;
export function did_new(a: number, b: number, c: number): void;
...
export function useroperation_register(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function useroperation_update(a: number, b: number, c: number): void;
...
export function subtreepolicies_withSchema(a: number, b: number, c: number): void;
export function subtreepolicies_withExpiration(a: number, b: number): number;
export function __wbg_bip44_free(a: number): void;
export function bip44_network(a: number, b: number, c: number, d: number): void;
...
export function bip44coin_account(a: number, b: number, c: number): void;
...
export function bip44account_chain(a: number, b: number, c: number): void;
export function bip44account_key(a: number, b: number, c: number): void;
...
export function bip44account_fromXprv(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function bip44publicaccount_chain(a: number, b: number, c: number): void;
export function bip44publicaccount_key(a: number, b: number, c: number): void;
...
export function bip44publicaccount_fromXpub(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function bip44subaccount_key(a: number, b: number, c: number): void;
...
export function bip44subaccount_fromXprv(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
...
export function bip44publicsubaccount_key(a: number, b: number, c: number): void;
...
export function bip44publicsubaccount_fromXpub(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
...
export function secpsignature_fromDer(a: number, b: number, c: number): void;
...
export function seed_new(a: number, b: number, c: number): void;
...
export function allNetworkNames(): number;
export function __wbg_morpheus_free(a: number): void;
export function morpheus_root(a: number, b: number): void;
export function __wbg_morpheusroot_free(a: number): void;
export function morpheusroot_bip32_path(a: number, b: number): void;
export function morpheusroot_kind(a: number, b: number, c: number, d: number): void;
export function morpheusroot_personas(a: number, b: number): void;
export function morpheusroot_devices(a: number, b: number): void;
export function morpheusroot_groups(a: number, b: number): void;
export function morpheusroot_resources(a: number, b: number): void;
...
export function morpheuskind_key(a: number, b: number, c: number): void;
...
export function bip32_master(a: number, b: number, c: number, d: number): void;
...
export function bip32node_deriveNormal(a: number, b: number, c: number): void;
export function bip32node_deriveHardened(a: number, b: number, c: number): void;
...
export function bip32publicnode_deriveNormal(a: number, b: number, c: number): void;
...
export function secppublickey_new(a: number, b: number, c: number): void;
...
export function bip39_new(a: number, b: number, c: number): void;
export function bip39_generate(a: number, b: number): void;
export function bip39_entropy(a: number, b: number, c: number, d: number): void;
export function bip39_shortEntropy(a: number, b: number, c: number, d: number): void;
export function bip39_validatePhrase(a: number, b: number, c: number, d: number): void;
export function bip39_listWords(a: number, b: number, c: number, d: number): void;
export function bip39_phrase(a: number, b: number, c: number, d: number): void;
export function bip39_shortPhrase(a: number, b: number, c: number, d: number): void;
...
export function secpprivatekey_fromArkPassphrase(a: number, b: number, c: number): void;
export function secpprivatekey_fromWif(a: number, b: number, c: number, d: number, e: number): void;
...
export function keyid_new(a: number, b: number, c: number): void;
...
export function secpkeyid_fromAddress(a: number, b: number, c: number, d: number, e: number): void;
export function secpkeyid_toAddress(a: number, b: number, c: number, d: number): void;
