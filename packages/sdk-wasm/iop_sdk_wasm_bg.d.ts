...
export function state_resolveData(a: number, b: number): number;
export function state_getMetadata(a: number, b: number): number;
export function state_getChildren(a: number, b: number): number;
export function state_lastNonce(a: number, b: number, c: number): void;
export function state_applySignedOperations(a: number, b: number, c: number): void;
export function state_applySystemOperation(a: number, b: number, c: number): void;
export function state_version(a: number, b: number): void;
export function state_undoLastOperation(a: number, b: number, c: number): void;
export function state_last_seen_height(a: number): number;
export function __wbg_noncedoperationsbuilder_free(a: number): void;
export function noncedoperationsbuilder_new(): number;
export function noncedoperationsbuilder_add(a: number, b: number): number;
export function noncedoperationsbuilder_build(a: number, b: number, c: number): number;
export function __wbg_noncedoperations_free(a: number): void;
export function noncedoperations_price(a: number, b: number): number;
export function noncedoperations_sign(a: number, b: number): number;
export function noncedoperations_serialize(a: number, b: number): void;
export function __wbg_signedoperations_free(a: number): void;
export function signedoperations_new(a: number): number;
export function signedoperations_price(a: number, b: number): number;
export function signedoperations_verify(a: number): number;
...
export function __wbg_systemoperation_free(a: number): void;
export function systemoperation_startBlock(a: number): number;
