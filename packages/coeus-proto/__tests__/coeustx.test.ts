...
import { ICoeusData, ICoeusAsset } from '../src';

describe('CoeusTransaction builder', () => {
  it('blah', () => {
    const secpSk = SecpPrivateKey.fromArkPassphrase('scout try doll stuff cake welcome random taste load town clerk ostrich');
    ...
    const asset: ICoeusAsset = tx.asset;
    expect(asset.signedOperations[0].nonce).toBe(2);
    expect(asset.signedOperations[0].publicKey).toBe(pk.toString());
    expect(asset.signedOperations[0].signature).toBe("ssz7ju84s3XedrTZhATxKEVLZjws79hVpjtnvZyhxDasWMuRWQd7eJZrWzLNeN982YgAyU62RBMchrrYWzrb2eiCHxJ");
    ...
    expect(signedTx.signature).toBe('304402207818326a5ae380810fda64f39a1e617cf65cdd015d2a8c07f3092dd3cd15ad0002207d294c480c30dcad3941657cae07a6c0f26a17f2cb71f9340e56b7755fa5d623');
