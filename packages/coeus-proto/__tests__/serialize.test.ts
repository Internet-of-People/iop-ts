...
describe('Serialize/deserialize works', () => {
  it('...', () => {
    const json = {"signedOperations":[{"operations":[{"type":"register","name":["schema","eidcard"],"owner":"psz2Bmoub8W72YEYshmbmLLExyN3tPxRun2Vk2SWEJJke6JM","subtreePolicies":{},"registrationPolicy":"owner","data":{},"expiresAtHeight":69}],"nonce":2,"publicKey":"psz2Bmoub8W72YEYshmbmLLExyN3tPxRun2Vk2SWEJJke6JM","signature":"ssz7pKbfUW2NvcnqRFKJjTCx46GVFy7X48PyUhFWoQVUwiFWVvb7541ocgRs67kBaV6X2YHDJXSEqxzr1K7YeL14f2t"}]};
